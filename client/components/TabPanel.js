      ...
      {value === index && (
        <>
          <Typography variant="subtitle2">
            {new Date(applicable_date).toLocaleDateString('ru-RU', {
              weekday: 'long',
              day: 'numeric',
              month: 'long',
              year: 'numeric',
          ...
          <div className={classes.info}>
            <div className={classes.currentInfo}>
              ...
              <div
                className={
                  window.innerWidth < 400 ? classes.smallIcon : classes.icon
                }
                style={{
                  background: `url("https://www.metaweather.com/static/img/weather/${weather_state_abbr}.svg")`,
                }}
              ></div>
            </div>
